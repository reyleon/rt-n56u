...
function show_banner(L3){
	...
	bc += '    <td><button type="button" id="logout_btn" class="btn btn-mini" style="height: 25px; outline:0;" title="<#t1Logout#>" onclick="logout();">注销</button> <button type="button" id="reboto_btn" class="btn btn-mini" style="height: 25px; outline:0;" title="<#BTN_REBOOT#>" onclick="reboot();">重启</button></td>\n';
	bc += '  </tr>\n';
	bc += '</table>\n';
	bc += '</div>\n';
	bc += '</div>\n';
